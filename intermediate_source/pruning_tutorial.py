...
**번역**: `이준혁 <https://github.com/wnsx0000>`_
...
연구 분야에서 가지치기는 파라미터가 많은 신경망과 적은 신경망 사이의 학습 동역학(learning dynamics)을 분석하거나,
소거 기반 신경망 구조 탐색(NAS, neural architecture search)의 일환으로 운이 좋게 잘 구성된 희소 신경망 또는 
초기화 기법의 ("`lottery tickets <https://arxiv.org/abs/1803.03635>`_") 역할을 연구하는 것 등을 목적으로 합니다.
